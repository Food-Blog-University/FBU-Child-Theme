        ...
        <div class="header-inner"  style="padding: <?php echo get_theme_mod( 'header_padding', '2rem 0 2rem 0' ); ?>;">
            <?php if ( get_option( 'puresimple_logo' ) ) : ?>
                ...
                <div class="logo fade-logo">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home"><img class="fbu-logo" src="<?php echo get_option( 'puresimple_logo' ); ?>" <?php echo tevkori_get_srcset_string( 102, 'Large' ); ?> alt="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?>"></a>
                </div>
